...
export class DisplacementComponent implements OnDestroy {
  readonly options = input<DisplacementOptions>({});
  ...
  private instance: DisplacementInstance | null = null;
  ...
  private create(): void {
    ...
    this.instance = createDisplacement(
