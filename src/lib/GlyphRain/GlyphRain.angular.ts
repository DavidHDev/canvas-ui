...
export class GlyphRainComponent implements OnDestroy {
  readonly options = input<GlyphRainOptions>({});
  ...
  private instance: GlyphRainInstance | null = null;
