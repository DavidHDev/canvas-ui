...
export class AsciifyComponent implements OnDestroy {
  readonly options = input<AsciifyOptions>({});
  ...
  private instance: AsciifyInstance | null = null;
