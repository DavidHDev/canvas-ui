...
export class RetroDitherComponent implements OnDestroy {
  readonly options = input<RetroDitherOptions>({});
  ...
  private instance: RetroDitherInstance | null = null;
  ...
  private create(): void {
    ...
    this.instance = createRetroDither(
