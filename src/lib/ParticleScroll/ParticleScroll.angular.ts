...
export class ParticleScrollComponent implements OnDestroy {
  readonly options = input<ParticleScrollOptions>({});
  ...
  private instance: ParticleScrollInstance | null = null;
  ...
  private create(): void {
    ...
    this.instance = createParticleScroll(
