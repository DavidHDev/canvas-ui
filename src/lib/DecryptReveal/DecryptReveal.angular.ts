...
export class DecryptRevealComponent implements OnDestroy {
  readonly options = input<DecryptRevealOptions>({});
  ...
  private instance: DecryptRevealInstance | null = null;
  ...
  private create(): void {
    ...
    this.instance = createDecryptReveal(
