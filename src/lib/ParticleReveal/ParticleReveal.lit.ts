...
export class CanvasUiParticleReveal extends LitElement {
  static properties = {
    radius: { type: Number },
    _native: { state: true },
    _failed: { state: true },
  ...
  _instance: ParticleRevealInstance | null = null;
  ...
  async firstUpdated(): Promise<void> {
    ...
    this._instance = createParticleReveal(
  ...
  private _getOptions(): ParticleRevealOptions {
    return {
...
if (!customElements.get("canvas-ui-particle-reveal")) {
  customElements.define("canvas-ui-particle-reveal", CanvasUiParticleReveal);
}
