...
export class ParticleRevealComponent implements OnDestroy {
  readonly options = input<ParticleRevealOptions>({});
  ...
  private instance: ParticleRevealInstance | null = null;
  ...
  private create(): void {
    ...
    this.instance = createParticleReveal(
