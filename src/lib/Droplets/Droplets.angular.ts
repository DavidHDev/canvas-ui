...
export class DropletsComponent implements OnDestroy {
  readonly options = input<DropletsOptions>({});
  ...
  private instance: DropletsInstance | null = null;
