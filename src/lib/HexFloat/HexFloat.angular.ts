...
export class HexFloatComponent implements OnDestroy {
  readonly options = input<HexFloatOptions>({});
  ...
  private instance: HexFloatInstance | null = null;
