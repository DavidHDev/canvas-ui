...
export class ForceFieldComponent implements OnDestroy {
  readonly options = input<ForceFieldOptions>({});
  ...
  private instance: ForceFieldInstance | null = null;
  ...
  private create(): void {
    ...
    this.instance = createForceField(
