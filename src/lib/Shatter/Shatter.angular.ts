...
export class ShatterComponent implements OnDestroy {
  readonly options = input<ShatterOptions>({});
  ...
  private instance: ShatterInstance | null = null;
