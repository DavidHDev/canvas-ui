...
const DESCRIPTION =
  "An open source component library of creative html-in-canvas and WebGL effects for React, Solid, Preact, Lit, Vue, Svelte, and vanilla JS. Creative effects running over live HTML.";
